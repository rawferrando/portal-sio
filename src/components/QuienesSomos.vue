    ...
    <div class="grid-servicios">
      ...
      <div class="tarjeta-servicio destacada" @click="$emit('ir-a-instrumentacion')">
        ...
        <div class="contenido-tarjeta">
          ...
          <p>Catálogo de sensores, CTDs y rosetas. Accede a las fichas técnicas y gestiona tus reservas.</p>
        </div>
      </div>
      ...
      <div class="tarjeta-servicio">
        ...
        <div class="contenido-tarjeta">
          ...
          <p>Análisis de muestras y salinometría de precisión.</p>
        </div>
      </div>
      ...
      <div class="tarjeta-servicio">
        ...
        <div class="contenido-tarjeta">
          ...
          <p>Preparación y envío de material científico para campañas.</p>
        </div>
      </div>
      ...
      <div class="tarjeta-servicio">
        ...
        <div class="contenido-tarjeta">
          ...
          <p>Despliegue de líneas de fondeo oceanográfico.</p>
        </div>
      </div>
