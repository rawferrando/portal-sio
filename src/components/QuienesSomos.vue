...
.hero-section { 
  ...
  padding: 15px 25px; /* Ajustado el padding lateral */
  border-radius: 8px; 
  margin-bottom: 40px; 
}
...
.hero-logo-box {
  flex: 0 0 280px; /* Logo ligeramente más compacto para ganar espacio */
}
...
@media (max-width: 950px) {
  .hero-container { flex-direction: column; text-align: center; margin: 0 auto; }
