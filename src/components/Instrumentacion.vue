...
const documentoActual = ref({
  equipoId: '', equipoNombre: '', equipoSn: '', desde: '', hasta: '', proyecto: '', fechaGeneracion: ''
})
...
const inventario = ref([
  { 
    ...
    reservas: [
      { desde: '2026-04-10', hasta: '2026-04-25', proyecto: 'Campaña Costa Brava', estado: 'Aprobada', archivo: 'Responsabilidad_SBE5_Firmado_Ribas.pdf' }
    ],
          ...
          <div v-if="equiposExpandidos.includes(equipo.id)" class="ficha-tecnica-desplegada">
            ...
            <div class="bloque-reservas">
                ...
                <ul>
                  <li v-for="(res, index) in equipo.reservas" :key="index" class="item-reserva">
                    ...
                    <div class="acciones-reserva">
                      <span v-if="res.estado === 'Aprobada'" class="estado-ok" :title="res.archivo">✅ Validado: {{ res.archivo.length > 15 ? res.archivo.substring(0, 15) + '...' : res.archivo }}</span>
              ...
              <div class="formulario-reserva">
                ...
                <button @click="solicitarReserva(equipo)" class="btn-generar-doc">Crear Solicitud y Descargar Documento</button>
              </div>
            </div>
...
.campo-etiquetado { display: flex; flex-direction: column; flex: 1; min-width: 140px; }
.campo-etiquetado label { font-size: 0.85rem; font-weight: bold; color: #005596; margin-bottom: 5px; }
.campo-etiquetado input { padding: 10px; border: 1px solid #ccc; border-radius: 4px; width: 100%; box-sizing: border-box; font-family: inherit; }
