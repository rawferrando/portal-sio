  ...
  try {
    ...
    for (let i = 1; i < filas.length; i++) {
      ...
      nuevosInstrumentos.push({
        ...
        descripcionCompleta: fila[idxDesc] || 'No hay descripción disponible.',
        parametros: fila[idxParams] || 'No hay parámetros técnicos especificados.'
      })
    }
...
const cambiarCategoria = (cat) => {
  ...
  instrumentoExpandido.value = null // Cierra el acordeón al cambiar de categoría
}
...
.texto-wiki { margin: 0; white-space: pre-line; color: #555; }
