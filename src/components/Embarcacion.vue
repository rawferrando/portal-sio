  ...
  <div class="pelagia-hub">
    ...
    <div class="contenedor-ancho contenido-hub">
      ...
      <div class="grid-detalles">
        <div class="seccion-bloque">
          ...
          <div class="lista-items-tecnicos">
            <div class="item-tecnico"><strong>Eslora:</strong> 7,5 metros</div>
            <div class="item-tecnico"><strong>Motorización:</strong> 200 HP fueraborda</div>
            <div class="item-tecnico"><strong>Capacidad:</strong> 6 personas (incluyendo patrón)</div>
            <div class="item-tecnico"><strong>Equipamiento:</strong> Grúa para despliegue, GPS diferencial y sonda.</div>
          </div>
        </div>
      ...
      <div class="grid-calendario-reservas">
        ...
        <div class="seccion-bloque">
          <h3 style="margin-top: 0; color: #012169; font-size: 1.3rem;">Campañas Programadas</h3>
...
/* FONDO CON LA IMAGEN PELAGIA.JPG */
.fondo-pelagia { 
  position: absolute; 
  top: 0; 
  left: 0; 
  width: 100%; 
  height: 550px; 
  background-image: linear-gradient(rgba(1, 33, 105, 0.7), rgba(1, 33, 105, 0.9)), 
                    url('/Pelagia.jpg');
...
/* ESTÉTICA DE FICHAS IGUAL A SERVICIOS E IDI */
.seccion-bloque { 
  background: white; 
  border-radius: 12px; 
  padding: 30px; 
...
.titulo-fija { color: #012169; margin-top: 0; font-size: 1.5rem; margin-bottom: 10px; }

.grid-detalles { display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 30px; }

.lista-items-tecnicos { display: flex; flex-direction: column; gap: 8px; margin-top: 10px; }
.item-tecnico { font-size: 0.95rem; color: #444; border-bottom: 1px solid #f0f0f0; padding-bottom: 5px; }
.item-tecnico:last-child { border-bottom: none; }

.texto-operaciones p { color: #555; line-height: 1.5; font-size: 0.95rem; margin-top: 10px; }

.separador { height: 1px; background: rgba(255,255,255,0.2); margin: 20px 0 30px 0; }
...
.dias-semana { display: grid; grid-template-columns: repeat(7, 1fr); text-align: center; font-weight: bold; color: #012169; margin-bottom: 10px; font-size: 0.85rem; }
.grid-dias { display: grid; grid-template-columns: repeat(7, 1fr); gap: 4px; }
.celda { aspect-ratio: 1; border: 1px solid #f0f0f0; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; border-radius: 4px; font-size: 0.9rem; }
.celda.vacio { border: none; }
.celda.ocupado { background: #eef7ff; border-color: #0086c0; color: #012169; font-weight: bold; }
.dot-campaña { width: 5px; height: 5px; background: #8cc63f; border-radius: 50%; margin-top: 3px; }

.lista-items { display: flex; flex-direction: column; gap: 0; margin-top: 10px; }
.item-reserva { display: flex; gap: 12px; padding: 10px 0; border-bottom: 1px solid #f0f0f0; margin-bottom: 0 !important; }
.item-reserva:last-child { border-bottom: none; }
.fecha-badge { background: #012169; color: white; padding: 3px 8px; border-radius: 4px; font-weight: bold; font-size: 0.8rem; height: fit-content; }
.detalles { display: flex; flex-direction: column; line-height: 1.2;}
.detalles strong { font-size: 0.9rem; color: #333; }
.detalles span { font-size: 0.8rem; color: #666; }
